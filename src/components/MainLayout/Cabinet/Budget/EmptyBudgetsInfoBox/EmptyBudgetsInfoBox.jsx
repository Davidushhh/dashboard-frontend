    ...
    emptyWidgets.length !== 0 && (
      <SC.BoxWrapper>
        ...
        <SC.InfoText>
          ...
          такі як відсутність оновлення даних, відсутність звітності або
          технічні обмеження. <br /> Ми рекомендуємо періодично перевіряти
          сторінку для оновлень щодо бюджетних даних.
        </SC.InfoText>
      </SC.BoxWrapper>
    )
  );
